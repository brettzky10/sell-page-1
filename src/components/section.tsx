...
const Section: React.FC<{image: StaticImageData; tag: string; title: string; description: string}> = ({image, tag, title, description}) => {
  ...
  return (
    <section ref={sectionRef} className='relative h-screen overflow-hidden'>
      ...
      <div className='flex flex-col gap-4 p-24 text-white'>
